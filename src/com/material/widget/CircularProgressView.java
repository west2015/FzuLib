...
public class CircularProgressView extends View {
    ...
    private static final float INDETERMINANT_MIN_SWEEP = 30f;
    ...
    private void initAttributes(AttributeSet attrs, int defStyle)
    {
        ...
        color = a.getColor(R.styleable.CircularProgressView_cpv_color, getResources().getColor(R.color.blue_500));
